                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                          ...
                          @foreach($doctors as $doctor)
                              <tr>
                                    ...
                                    <td>
                                        @if($doctor->image)
                                            <img src="{{Url::asset('assets/img/doctors/'.$doctor->image->filename)}}" height="50px" width="50px" alt="">
                                        @else
                                            <img src="{{Url::asset('assets/img/doctor_default.png')}}" height="50px" width="50px" alt="">
                                        @endif
                                    </td>
                                    <td>{{ $doctor->name }}</td>
                                    <td>{{ $doctor->email }}</td>
