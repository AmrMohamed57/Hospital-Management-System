...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المرضي</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/  معلومات المريض</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                                    <div class="tab-content">
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center" id="example1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="alert alert-danger">
                                                            <span class="text-danger"> {{$Debit - $credit}}</span>                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <p>تفاصيل تقرير الأشعة:</p>
                                            <p class="mb-0">تم إجراء الأشعة بناءً على طلب الطبيب لفحص المنطقة المصابة. النتائج تظهر وجود تشوهات في
                                            العظام، مع احتمالية وجود كسر طفيف في المنطقة المرصودة. لا توجد دلائل على تورم أو التهابات كبيرة، ولكن
                                            يُنصح بمزيد من الفحوصات للتأكد من عدم وجود أي مضاعفات.</p>
                                            <p class="mb-0">يرجى المتابعة مع الطبيب المختص لتقييم الحالة بناءً على النتائج الحالية، واتخاذ الإجراءات
                                            اللازمة لضمان التعافي السريع.</p>
                                        </div>

                                        <div class="tab-pane" id="tab6">
                                            <p>تفاصيل تقرير التحاليل المخبرية:</p>
                                            <p class="mb-0">تم إجراء التحاليل المطلوبة بناءً على توصية الطبيب المختص. النتائج تشير إلى مستويات طبيعية
                                            في معظم المؤشرات الحيوية، باستثناء ارتفاع طفيف في مستوى السكر في الدم والذي يحتاج إلى متابعة إضافية.
                                            تحليل وظائف الكلى والكبد جاءت ضمن المعدلات الطبيعية.</p>
                                            <p class="mb-0">يرجى مراجعة الطبيب لتفسير النتائج بشكل أدق واتخاذ الإجراءات الطبية اللازمة في حال وجود أي
                                            مخاطر صحية أو الحاجة إلى متابعة علاجية.</p>
                                        </div>
