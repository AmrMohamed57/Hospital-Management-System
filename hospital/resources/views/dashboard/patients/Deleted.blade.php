        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('Patients.destroy', 'test') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> هل انت متاكد من حذف بيانات المريض {{ $Patient->name }} ؟ </p>
                            <input type="hidden" class="form-control" readonly value="{{ $Patient->name }}">
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-success">حذف المريض</button>
                    </div>
                </form>
            </div>
        </div>
