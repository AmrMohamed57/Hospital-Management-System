                    ...
                    <div class="col-lg-4 ml-auto text-right">
                        <table class="table pull-right">
                            ...
                            <tr>
                                ...
                                <td width="125">
                                    <input type="number" name="discount_value" class="form-control w-75 d-inline" wire:model.live="discount_value">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="taxes" class="form-control w-75 d-inline" min="0" max="100" wire:model.live="taxes"> %
                                </td>
                            </tr>
                            <tr>
