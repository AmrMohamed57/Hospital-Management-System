        ...
        <div class="header-upper">
            <div class="inner-container clearfix">
                ...
                <div class="logo-outer">
                    <div class="logo"><a href="#"><img style="width: 12rem ; height:5rem" src="{{URL::asset('WebSite/images/gallery/logo.jpg')}}" alt="" title=""></a></div>
                </div>
            ...
            <form>
                <div class="form-group">
                    <fieldset>
                        ...
                        <input type="submit" value="ابحث الآن!" class="theme-btn">
                    </fieldset>
                </div>
            </form>
            <br>
            <h3>الكلمات المفتاحية للبحث الأخير</h3>
            <ul class="recent-searches">
                <li><a href="#">الطب</a></li>
                <li><a href="#">إدارة المستشفيات</a></li>
                <li><a href="#">رعاية المرضى</a></li>
                <li><a href="#">الخدمات الطبية</a></li>
                <li><a href="#">الاستشارات الصحية</a></li>
            </ul>
        </div>
                ...
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                       ...
                       <div class="content-box">
                            <h2>معلومات عنا</h2>
                            <p class="text">القيم الأساسية هي المعتقدات الأساسية لشخص أو منظمة. القيم الأساسية هي المبادئ التوجيهية التي تحدد السلوك والعمل.</p>
                            <a href="#" class="theme-btn btn-style-two"><span class="txt">استشارة</span></a>
                        </div>
                        <div class="contact-info">
                            <h2>معلومات الاتصال</h2>
                            <ul class="list-style-two">
                                <li><span class="icon flaticon-map"></span>شيكاغو 12، مدينة ميلبورن، الولايات المتحدة الأمريكية</li>
                                ...
                                <li><span class="icon flaticon-timetable"></span>أيام الأسبوع: 09:00 إلى 18:00، الأحد: مغلق</li>
                            </ul>
                        </div>
